...
class opts(object):
  ...
  def parse(self, args=''):
    ...
    # opt.data_dir = os.path.abspath('/home/ridhwan/detection_datasets')
    opt.data_dir = os.path.abspath('/media/ridhwan/41b91e9e-9e35-4b55-9fd9-5c569c51d214/detection_datasets')
